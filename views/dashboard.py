"""PredictiveOps — landing, OEE scorecard, quick navigation."""

import streamlit as st

import database
from maintenance.bootstrap import fleet_status_color, model_metadata, render_demo_sidebar, render_sidebar_footer
...
page_setup("Dashboard", "🏠", set_config=False)
